...
class ConfigServiceTestCase(unittest.TestCase):
  ...
  def test_load_config_normalizes_embedding_to_match_model_family(self) -> None:
    ...
    self.assertEqual(loaded.embedding.provider, "volcengine-ark")
    self.assertEqual(loaded.embedding.base_url, "https://ark.cn-beijing.volces.com/api/coding/v3")
    self.assertEqual(loaded.embedding.model_name, "doubao-embedding-vision")
